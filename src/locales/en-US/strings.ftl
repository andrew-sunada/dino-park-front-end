...
access-group_close-group = Close group
  .part-1 = This action will send a request to the administrator to completely delete this access group and remove all members. To continue, please check the box labeled
  .part-2 = I understand...
  .part-3 = and then click the
  .part-4 = Send close request
  .part-5 = button.
  .confirm-text = I understand this action will result in the entire access group being deleted
  .confirm-close = Send close request
